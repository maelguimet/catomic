...
Next intended Phase 2B steps (post 2-at):
...
- The 2026-07-07 phase split is recorded; after LF-only, owned-input, and newline-search reductions, `read_to_string` is the largest measured editor-owned subphase for the synthetic no-newline 100 MiB file. Line-heavy manual smokes show `PieceTable::from_owned_text`/LineIndex cost reappearing for newline-rich content. Full materialization remains the larger design limitation.
