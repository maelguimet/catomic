...
Next intended Phase 2B steps (post 2-ay):
- Decide the next Huge-file policy step: immutable external-change snapshot behavior, editable Huge semantics, or scan/render optimization. Keep any next move narrow and backed by ignored manual measurements.
