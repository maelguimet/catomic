...
Key unresolved limitations (still current post 2-al):
...
Next intended Phase 2B steps (post 2-an):
...
- The 2026-07-07 phase split is recorded; `PieceTable::from_text` remains the main measured open/materialization subphase after the LF-only normalization fast path.
