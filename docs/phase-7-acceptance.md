...
| Plain-mode discipline | Plain startup may load inert configuration, but constructs no Project service, network client, background indexer, or external process. External and LLM work remains explicit and asynchronous. |
