...
pub(crate) const PROMPT_COMMANDS: &[PromptCommandSpec] = &[
    ...
    command(PromptCommand::Project, &["project", "code"]),
    command(PromptCommand::Plain, &["plain", "text"]),
    command(PromptCommand::Files, &["files"]),
    command(PromptCommand::Lint, &["lint"]),
    command(PromptCommand::Diagnostics, &["diagnostics", "dlist"]),
    command(PromptCommand::DiagnosticNext, &["dnext"]),
    command(PromptCommand::DiagnosticPrevious, &["dprev"]),
    ...
    command(PromptCommand::Autocomplete, &["autocomplete"]),
